...
let cat = try await run(.name("cat"), input: .fileDescriptor(fd, closeAfterSpawningProcess: true))
...
@available(macOS 9999, *) // Span equivelent
public struct StringOutput: ManagedOutputProtocol { }
